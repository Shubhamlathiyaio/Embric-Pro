...
class CommonButton extends StatelessWidget {
  final dynamic child; // Accepts both String and Widget
  ...
  Widget build(BuildContext context) {
    ...
    Widget textWidget = child is String
        ? Text(child,
            style: TextStyle(
              fontSize: fontSize,
    ...
    switch (iconDirection) {
      case IconDirection.left:
        children = [iconWidget, if (icon != null) SizedBox(width: 8), textWidget];
        break;
      case IconDirection.right:
        children = [textWidget, if (icon != null) SizedBox(width: 8), iconWidget];
        break;
      case IconDirection.top:
        children = [iconWidget, if (icon != null) SizedBox(height: 4), textWidget];
        break;
      case IconDirection.bottom:
        children = [textWidget, if (icon != null) SizedBox(height: 4), iconWidget];
        break;
    }
